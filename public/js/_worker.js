...
// ⚠️ เพิ่ม อบต. ใหม่ทุกครั้งได้โดยเติมรหัสลงในลิสต์นี้เท่านั้น (จุดเดียวฝั่ง Backend)
// รหัสในลิสต์นี้ต้องตรงกับค่า ABT_CODE ที่ตั้งไว้ใน config.js ของแต่ละโปรเจกต์ อบต.
